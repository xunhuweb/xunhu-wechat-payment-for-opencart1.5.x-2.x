...
class ControllerExtensionPaymentxhopenwechat extends Controller {
	...
	public function index() {
		...
		return $this->load->view('payment/xhopenwechat.tpl', $data);
	}
	...
	public function send() {
	    ...
	    $xhopenwechat_transaction_url = rtrim($this->config->get('xhopenwechat_transaction_url'),'/');
		...
		$url              = $xhopenwechat_transaction_url.'/payment/do.html';
	...
	public function notify(){
	    ...
	    if(isset($data['plugins'])&&$data['plugins']!='opencart-xhopenwechat'){
	        return;
	    }
