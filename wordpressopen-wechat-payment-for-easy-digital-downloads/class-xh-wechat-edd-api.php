...
class XH_Wechat_Payment_EDD_Api{
    ...
    public function register_activation_hook(){
        ...
        if(empty($val)){
            edd_update_option('xh_wechat_payment_edd_appid','20146123713');
        }
        
        $val =edd_get_option('xh_wechat_payment_edd_appsecret');
        if(empty($val)){
            edd_update_option('xh_wechat_payment_edd_appsecret','6D7B025B8DD098C485F0805193136FB9');
        }
        
        $val =edd_get_option('xh_wechat_payment_edd_transaction_url');
        if(empty($val)){
            edd_update_option('xh_wechat_payment_edd_transaction_url','https://pay.xunhupay.com');
        }
